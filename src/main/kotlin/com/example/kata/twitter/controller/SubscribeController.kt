...
import com.example.kata.twitter.gateway.WeatherPredicton
...
class SubscribeController(
        private val ipmaGateway: WeatherPredicton,
    ...
    fun subscribeTweet(@PathVariable locationId: String): ResponseEntity<WeatherData>{
